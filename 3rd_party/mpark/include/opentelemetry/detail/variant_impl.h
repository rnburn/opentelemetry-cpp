...
#ifndef OPENTELEMETRY_VARIANT_IMPL_H
#define OPENTELEMETRY_VARIANT_IMPL_H
...
#ifndef OPENTELEMETRY_CONFIG_HPP
#define OPENTELEMETRY_CONFIG_HPP
...
#define OPENTELEMETRY_ALWAYS_INLINE __attribute__((__always_inline__)) inline
#elif defined(_MSC_VER)
#define OPENTELEMETRY_ALWAYS_INLINE __forceinline
#else
#define OPENTELEMETRY_ALWAYS_INLINE inline
#endif

#if __has_builtin(__builtin_addressof) || \
    (defined(__GNUC__) && __GNUC__ >= 7) || defined(_MSC_VER)
#define OPENTELEMETRY_BUILTIN_ADDRESSOF
#endif

#if __has_builtin(__builtin_unreachable) || defined(__GNUC__)
#define OPENTELEMETRY_BUILTIN_UNREACHABLE __builtin_unreachable()
#elif defined(_MSC_VER)
#define OPENTELEMETRY_BUILTIN_UNREACHABLE __assume(false)
#else
#define OPENTELEMETRY_BUILTIN_UNREACHABLE
#endif

#if __has_builtin(__type_pack_element)
#define OPENTELEMETRY_TYPE_PACK_ELEMENT
#endif

#if defined(__cpp_constexpr) && __cpp_constexpr >= 200704 && \
    !(defined(__GNUC__) && __GNUC__ == 4 && __GNUC_MINOR__ == 9)
#define OPENTELEMETRY_CPP11_CONSTEXPR
#endif

#if defined(__cpp_constexpr) && __cpp_constexpr >= 201304
#define OPENTELEMETRY_CPP14_CONSTEXPR
#endif

#if __has_feature(cxx_exceptions) || defined(__cpp_exceptions) || \
    (defined(_MSC_VER) && defined(_CPPUNWIND))
#define OPENTELEMETRY_EXCEPTIONS
#endif

#if defined(__cpp_generic_lambdas) || defined(_MSC_VER)
#define OPENTELEMETRY_GENERIC_LAMBDAS
#endif

#if defined(__cpp_lib_integer_sequence)
#define OPENTELEMETRY_INTEGER_SEQUENCE
#endif

#if defined(__cpp_return_type_deduction) || defined(_MSC_VER)
#define OPENTELEMETRY_RETURN_TYPE_DEDUCTION
#endif

#if defined(__cpp_lib_transparent_operators) || defined(_MSC_VER)
#define OPENTELEMETRY_TRANSPARENT_OPERATORS
#endif

#if defined(__cpp_variable_templates) || defined(_MSC_VER)
#define OPENTELEMETRY_VARIABLE_TEMPLATES
#endif

#if !defined(__GLIBCXX__) || __has_include(<codecvt>)  // >= libstdc++-5
#define OPENTELEMETRY_TRIVIALITY_TYPE_TRAITS
#define OPENTELEMETRY_INCOMPLETE_TYPE_TRAITS
#endif

#endif  // OPENTELEMETRY_CONFIG_HPP
...
#ifndef OPENTELEMETRY_IN_PLACE_HPP
#define OPENTELEMETRY_IN_PLACE_HPP
...
#ifdef OPENTELEMETRY_VARIABLE_TEMPLATES
...
#endif  // OPENTELEMETRY_IN_PLACE_HPP
...
#ifndef OPENTELEMETRY_LIB_HPP
#define OPENTELEMETRY_LIB_HPP
...
namespace opentelemetry {
  namespace lib {
    ...
    inline namespace cpp14 {
...
#ifdef OPENTELEMETRY_INTEGER_SEQUENCE
      ...
      // <functional>
#ifdef OPENTELEMETRY_TRANSPARENT_OPERATORS
      using equal_to = std::equal_to<>;
#else
      struct equal_to {
        template <typename Lhs, typename Rhs>
        inline constexpr auto operator()(Lhs &&lhs, Rhs &&rhs) const
          OPENTELEMETRY_RETURN(lib::forward<Lhs>(lhs) == lib::forward<Rhs>(rhs))
      };
#endif
      ...
      namespace detail {
        ...
        struct Invoke<true /* pmf */, 0 /* is_base_of */> {
          ...
          inline static constexpr auto invoke(R T::*pmf, Arg &&arg, Args &&... args)
            OPENTELEMETRY_RETURN((lib::forward<Arg>(arg).*pmf)(lib::forward<Args>(args)...))
        };
        ...
        struct Invoke<true /* pmf */, 1 /* is_reference_wrapper */> {
          template <typename R, typename T, typename Arg, typename... Args>
          inline static constexpr auto invoke(R T::*pmf, Arg &&arg, Args &&... args)
            OPENTELEMETRY_RETURN((lib::forward<Arg>(arg).get().*pmf)(lib::forward<Args>(args)...))
        };
        ...
        struct Invoke<false /* pmo */, 0 /* is_base_of */> {
          ...
          inline static constexpr auto invoke(R T::*pmo, Arg &&arg)
            OPENTELEMETRY_RETURN(lib::forward<Arg>(arg).*pmo)
        };
        ...
        struct Invoke<false /* pmo */, 1 /* is_reference_wrapper */> {
          template <typename R, typename T, typename Arg>
          inline static constexpr auto invoke(R T::*pmo, Arg &&arg)
            OPENTELEMETRY_RETURN(lib::forward<Arg>(arg).get().*pmo)
        };
...
#pragma warning(disable : 4100)
        ...
        inline constexpr auto invoke(F &&f, Args &&... args)
          OPENTELEMETRY_RETURN(lib::forward<F>(f)(lib::forward<Args>(args)...))
#ifdef _MSC_VER
#pragma warning(pop)
#endif
      }  // namespace detail
      ...
      template <typename F, typename... Args>
      inline constexpr auto invoke(F &&f, Args &&... args)
        OPENTELEMETRY_RETURN(detail::invoke(lib::forward<F>(f),
                                    lib::forward<Args>(args)...))
      ...
      // <memory>
#ifdef OPENTELEMETRY_BUILTIN_ADDRESSOF
      template <typename T>
...
#ifdef OPENTELEMETRY_TYPE_PACK_ELEMENT
...
#endif  // OPENTELEMETRY_LIB_HPP


namespace opentelemetry {

#ifdef OPENTELEMETRY_RETURN_TYPE_DEDUCTION
...
#ifdef OPENTELEMETRY_EXCEPTIONS
    throw bad_variant_access{};
#else
    std::terminate();
    OPENTELEMETRY_BUILTIN_UNREACHABLE;
#endif
  }
...
#ifdef OPENTELEMETRY_CPP14_CONSTEXPR
...
#if defined(OPENTELEMETRY_CPP14_CONSTEXPR) && !defined(_MSC_VER)
#define OPENTELEMETRY_VARIANT_SWITCH_VISIT
#endif
      ...
      struct base {
...
#ifdef OPENTELEMETRY_VARIANT_SWITCH_VISIT
        ...
        struct dispatcher<false, R, ITs...> {
          ...
          OPENTELEMETRY_ALWAYS_INLINE static constexpr R dispatch(
              F &&, typename ITs::type &&..., Vs &&...) {
            OPENTELEMETRY_BUILTIN_UNREACHABLE;
          }

          template <std::size_t I, typename F, typename... Vs>
          OPENTELEMETRY_ALWAYS_INLINE static constexpr R dispatch_case(F &&, Vs &&...) {
            OPENTELEMETRY_BUILTIN_UNREACHABLE;
          }

          template <std::size_t B, typename F, typename... Vs>
          OPENTELEMETRY_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t,
                                                             F &&,
                                                             Vs &&...) {
            OPENTELEMETRY_BUILTIN_UNREACHABLE;
          }
...
#define OPENTELEMETRY_DISPATCH(I)                                                   \
...
#define OPENTELEMETRY_DEFAULT(I)                                                      \
  dispatcher<(I < lib::decay_t<V>::size()), R, ITs...>::template dispatch<I>( \
      ...
      lib::forward<Vs>(vs)...)
            ...
            switch (v.index()) {
              case B + 0: return OPENTELEMETRY_DISPATCH(B + 0);
              case B + 1: return OPENTELEMETRY_DISPATCH(B + 1);
              case B + 2: return OPENTELEMETRY_DISPATCH(B + 2);
              case B + 3: return OPENTELEMETRY_DISPATCH(B + 3);
              case B + 4: return OPENTELEMETRY_DISPATCH(B + 4);
              case B + 5: return OPENTELEMETRY_DISPATCH(B + 5);
              case B + 6: return OPENTELEMETRY_DISPATCH(B + 6);
              case B + 7: return OPENTELEMETRY_DISPATCH(B + 7);
              case B + 8: return OPENTELEMETRY_DISPATCH(B + 8);
              case B + 9: return OPENTELEMETRY_DISPATCH(B + 9);
              case B + 10: return OPENTELEMETRY_DISPATCH(B + 10);
              case B + 11: return OPENTELEMETRY_DISPATCH(B + 11);
              case B + 12: return OPENTELEMETRY_DISPATCH(B + 12);
              case B + 13: return OPENTELEMETRY_DISPATCH(B + 13);
              case B + 14: return OPENTELEMETRY_DISPATCH(B + 14);
              case B + 15: return OPENTELEMETRY_DISPATCH(B + 15);
              case B + 16: return OPENTELEMETRY_DISPATCH(B + 16);
              case B + 17: return OPENTELEMETRY_DISPATCH(B + 17);
              case B + 18: return OPENTELEMETRY_DISPATCH(B + 18);
              case B + 19: return OPENTELEMETRY_DISPATCH(B + 19);
              case B + 20: return OPENTELEMETRY_DISPATCH(B + 20);
              case B + 21: return OPENTELEMETRY_DISPATCH(B + 21);
              case B + 22: return OPENTELEMETRY_DISPATCH(B + 22);
              case B + 23: return OPENTELEMETRY_DISPATCH(B + 23);
              case B + 24: return OPENTELEMETRY_DISPATCH(B + 24);
              case B + 25: return OPENTELEMETRY_DISPATCH(B + 25);
              case B + 26: return OPENTELEMETRY_DISPATCH(B + 26);
              case B + 27: return OPENTELEMETRY_DISPATCH(B + 27);
              case B + 28: return OPENTELEMETRY_DISPATCH(B + 28);
              case B + 29: return OPENTELEMETRY_DISPATCH(B + 29);
              case B + 30: return OPENTELEMETRY_DISPATCH(B + 30);
              case B + 31: return OPENTELEMETRY_DISPATCH(B + 31);
              default: return OPENTELEMETRY_DEFAULT(B + 32);
            }

#undef OPENTELEMETRY_DEFAULT
#undef OPENTELEMETRY_DISPATCH
          }

          template <std::size_t I, typename F, typename... Vs>
          OPENTELEMETRY_ALWAYS_INLINE static constexpr R dispatch_case(F &&f,
                                                               Vs &&... vs) {
            using Expected = R;
          ...
          template <std::size_t B, typename F, typename V, typename... Vs>
          OPENTELEMETRY_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t index,
                                                             F &&f,
                                                             V &&v,
                                                             Vs &&... vs) {
...
#define OPENTELEMETRY_DISPATCH_AT(I)                                               \
...
#define OPENTELEMETRY_DEFAULT(I)                                                 \
  dispatcher<(I < lib::decay_t<V>::size()), R>::template dispatch_at<I>( \
      index, lib::forward<F>(f), lib::forward<V>(v), lib::forward<Vs>(vs)...)
            ...
            switch (index) {
              case B + 0: return OPENTELEMETRY_DISPATCH_AT(B + 0);
              case B + 1: return OPENTELEMETRY_DISPATCH_AT(B + 1);
              case B + 2: return OPENTELEMETRY_DISPATCH_AT(B + 2);
              case B + 3: return OPENTELEMETRY_DISPATCH_AT(B + 3);
              case B + 4: return OPENTELEMETRY_DISPATCH_AT(B + 4);
              case B + 5: return OPENTELEMETRY_DISPATCH_AT(B + 5);
              case B + 6: return OPENTELEMETRY_DISPATCH_AT(B + 6);
              case B + 7: return OPENTELEMETRY_DISPATCH_AT(B + 7);
              case B + 8: return OPENTELEMETRY_DISPATCH_AT(B + 8);
              case B + 9: return OPENTELEMETRY_DISPATCH_AT(B + 9);
              case B + 10: return OPENTELEMETRY_DISPATCH_AT(B + 10);
              case B + 11: return OPENTELEMETRY_DISPATCH_AT(B + 11);
              case B + 12: return OPENTELEMETRY_DISPATCH_AT(B + 12);
              case B + 13: return OPENTELEMETRY_DISPATCH_AT(B + 13);
              case B + 14: return OPENTELEMETRY_DISPATCH_AT(B + 14);
              case B + 15: return OPENTELEMETRY_DISPATCH_AT(B + 15);
              case B + 16: return OPENTELEMETRY_DISPATCH_AT(B + 16);
              case B + 17: return OPENTELEMETRY_DISPATCH_AT(B + 17);
              case B + 18: return OPENTELEMETRY_DISPATCH_AT(B + 18);
              case B + 19: return OPENTELEMETRY_DISPATCH_AT(B + 19);
              case B + 20: return OPENTELEMETRY_DISPATCH_AT(B + 20);
              case B + 21: return OPENTELEMETRY_DISPATCH_AT(B + 21);
              case B + 22: return OPENTELEMETRY_DISPATCH_AT(B + 22);
              case B + 23: return OPENTELEMETRY_DISPATCH_AT(B + 23);
              case B + 24: return OPENTELEMETRY_DISPATCH_AT(B + 24);
              case B + 25: return OPENTELEMETRY_DISPATCH_AT(B + 25);
              case B + 26: return OPENTELEMETRY_DISPATCH_AT(B + 26);
              case B + 27: return OPENTELEMETRY_DISPATCH_AT(B + 27);
              case B + 28: return OPENTELEMETRY_DISPATCH_AT(B + 28);
              case B + 29: return OPENTELEMETRY_DISPATCH_AT(B + 29);
              case B + 30: return OPENTELEMETRY_DISPATCH_AT(B + 30);
              case B + 31: return OPENTELEMETRY_DISPATCH_AT(B + 31);
              default: return OPENTELEMETRY_DEFAULT(B + 32);
            }

#undef OPENTELEMETRY_DEFAULT
#undef OPENTELEMETRY_DISPATCH_AT
          }
        };
#else
        template <typename T>
...
#if !defined(OPENTELEMETRY_VARIANT_SWITCH_VISIT) && \
...
#define OPENTELEMETRY_VARIANT_RECURSIVE_UNION(destructible_trait, destructor)      \
  ...
  union recursive_union<destructible_trait, Index, T, Ts...> {             \
    ...
    OPENTELEMETRY_VARIANT_RECURSIVE_UNION(Trait::TriviallyAvailable,
                                  ~recursive_union() = default;);
    OPENTELEMETRY_VARIANT_RECURSIVE_UNION(Trait::Available,
                                  ~recursive_union() {});
    OPENTELEMETRY_VARIANT_RECURSIVE_UNION(Trait::Unavailable,
...
#define OPENTELEMETRY_INHERITING_CTOR(type, base) using base::base;
#else
#define OPENTELEMETRY_INHERITING_CTOR(type, base)         \
  template <typename... Args>                     \
...
#define OPENTELEMETRY_VARIANT_DESTRUCTOR(destructible_trait, definition, destroy) \
  ...
  class destructor<traits<Ts...>, destructible_trait>                     \
    ...
    using super = base<destructible_trait, Ts...>;                        \
                                                                          \
    public:                                                               \
    OPENTELEMETRY_INHERITING_CTOR(destructor, super)                              \
...
#undef OPENTELEMETRY_VARIANT_DESTRUCTOR
    ...
    class constructor : public destructor<Traits> {
      ...
      public:
      OPENTELEMETRY_INHERITING_CTOR(constructor, super)
      using super::operator=;

      protected:
#ifndef OPENTELEMETRY_GENERIC_LAMBDAS
      struct ctor {
      ...
      inline static void generic_construct(constructor &lhs, Rhs &&rhs) {
        ...
        if (!rhs.valueless_by_exception()) {
          visitation::alt::visit_alt_at(
              rhs.index(),
#ifdef OPENTELEMETRY_GENERIC_LAMBDAS
...
#define OPENTELEMETRY_VARIANT_MOVE_CONSTRUCTOR(move_constructible_trait, definition) \
  ...
  class move_constructor<traits<Ts...>, move_constructible_trait>            \
    ...
    using super = constructor<traits<Ts...>>;                                \
                                                                             \
    public:                                                                  \
    OPENTELEMETRY_INHERITING_CTOR(move_constructor, super)                           \
    using super::operator=;                                                  \
                                                                             \
...
#define OPENTELEMETRY_VARIANT_COPY_CONSTRUCTOR(copy_constructible_trait, definition) \
  ...
  class copy_constructor<traits<Ts...>, copy_constructible_trait>            \
    ...
    using super = move_constructor<traits<Ts...>>;                           \
                                                                             \
    public:                                                                  \
    OPENTELEMETRY_INHERITING_CTOR(copy_constructor, super)                           \
    using super::operator=;                                                  \
                                                                             \
    definition                                                               \
...
#undef OPENTELEMETRY_VARIANT_COPY_CONSTRUCTOR
    ...
    class assignment : public copy_constructor<Traits> {
      ...
      public:
      OPENTELEMETRY_INHERITING_CTOR(assignment, super)
      using super::operator=;
...
#define OPENTELEMETRY_VARIANT_MOVE_ASSIGNMENT(move_assignable_trait, definition) \
  ...
  class move_assignment<traits<Ts...>, move_assignable_trait>            \
    ...
    using super = assignment<traits<Ts...>>;                             \
                                                                         \
    public:                                                              \
    OPENTELEMETRY_INHERITING_CTOR(move_assignment, super)                        \
    using super::operator=;                                              \
                                                                         \
...
#define OPENTELEMETRY_VARIANT_COPY_ASSIGNMENT(copy_assignable_trait, definition) \
  ...
  class copy_assignment<traits<Ts...>, copy_assignable_trait>            \
    ...
    using super = move_assignment<traits<Ts...>>;                        \
                                                                         \
    public:                                                              \
    OPENTELEMETRY_INHERITING_CTOR(copy_assignment, super)                        \
    using super::operator=;                                              \
                                                                         \
...
#undef OPENTELEMETRY_VARIANT_COPY_ASSIGNMENT
    ...
    class impl : public copy_assignment<traits<Ts...>> {
      ...
      public:
      OPENTELEMETRY_INHERITING_CTOR(impl, super)
      using super::operator=;
...
#undef OPENTELEMETRY_INHERITING_CTOR
...
namespace std {
  ...
  template <typename... Ts>
  struct hash<opentelemetry::detail::enabled_type<
      opentelemetry::variant<Ts...>,
      opentelemetry::lib::enable_if_t<opentelemetry::lib::all<opentelemetry::detail::hash::is_enabled<
          opentelemetry::lib::remove_const_t<Ts>>()...>::value>>> {
    using argument_type = opentelemetry::variant<Ts...>;
    using result_type = std::size_t;

    inline result_type operator()(const argument_type &v) const {
      using opentelemetry::detail::visitation::variant;
      std::size_t result =
...
#ifdef OPENTELEMETRY_GENERIC_LAMBDAS
                    [](const auto &alt) {
                      using alt_type = opentelemetry::lib::decay_t<decltype(alt)>;
                      using value_type = opentelemetry::lib::remove_const_t<
    ...
    struct hasher {
      ...
      inline std::size_t operator()(const Alt &alt) const {
        using alt_type = opentelemetry::lib::decay_t<Alt>;
        using value_type =
            opentelemetry::lib::remove_const_t<typename alt_type::value_type>;
        return hash<value_type>{}(alt.value);
      }
    };
#endif
  ...
  template <>
  struct hash<opentelemetry::monostate> {
    using argument_type = opentelemetry::monostate;
    using result_type = std::size_t;
...
#endif  // OPENTELEMETRY_VARIANT_IMPL_H
